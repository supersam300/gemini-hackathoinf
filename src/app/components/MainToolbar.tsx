...
export function MainToolbar({ activeTool, onToolChange, zoom, onZoomChange, onUndo, onRedo, onResetView, onSimulate, isSimulating, darkMode, boardName }: MainToolbarProps) {
  ...
  return (
    <div
      className={`flex items-center h-[42px] border-b px-2.5 gap-0.5 shrink-0 overflow-x-auto shadow-sm ${
        dm
    ...
    >
      ...
      <div className={`flex items-center h-[26px] border rounded-[2px] px-2 min-w-[54px] justify-center text-[12px] select-none ${
        dm
      ...
      <div className="ml-auto flex items-center gap-1.5 shrink-0">
        ...
        <div className={`flex items-center h-[26px] border rounded-[2px] px-2 text-[12px] select-none ${
          dm
            ? 'border-[#555] bg-[#3c3c3c] text-[#ccc]'
            : 'border-[#b0b0b0] bg-white text-[#2a2a2a]'
        }`}>
